...
public class ProveedoresBDD {
	...
	public ArrayList<Proveedor> buscar(String subcadena) throws KrakedevException {
		...
		try {
			...
			ps = con.prepareStatement("select prov.identificador,tipo_documento,td.descripcion,prov.nombre,prov.telefono,prov.correo,prov.direccion"
			...
			while (rs.next()) {
				...
				TipoDocumento tp = new TipoDocumento(codigoTipoDocumento,descripcionTipoDocumento);
